...
public class ItemAlchemicalFuel extends ItemEE {
    ...
    public String getUnlocalizedName() {
        return String.format(
            "item.%s%s", Textures.RESOURCE_PREFIX, Names.Items.ALCHEMICAL_FUEL
        );
    }
    ...
    public String getUnlocalizedName(ItemStack itemStack) {
        return String.format(
            ...
            Names.Items.ALCHEMICAL_FUEL,
            Names.Items.ALCHEMICAL_FUEL_SUBTYPES[MathHelper.clamp_int(
                itemStack.getItemDamage(),
                0,
                Names.Items.ALCHEMICAL_FUEL_SUBTYPES.length - 1
            )]
        );
    }
    ...
    public IIcon getIconFromDamage(int meta) {
        return icons[MathHelper.clamp_int(
            meta, 0, Names.Items.ALCHEMICAL_FUEL_SUBTYPES.length - 1
        )];
    }
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < Names.Items.ALCHEMICAL_FUEL_SUBTYPES.length; i++) {
            icons[i] = iconRegister.registerIcon(
                Textures.RESOURCE_PREFIX + Names.Items.ALCHEMICAL_FUEL + "."
