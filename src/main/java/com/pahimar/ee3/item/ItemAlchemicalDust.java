...
public class ItemAlchemicalDust extends ItemEE {
    ...
    public String getUnlocalizedName() {
        return String.format(
            "item.%s%s", Textures.RESOURCE_PREFIX, Names.Items.ALCHEMICAL_DUST
        );
    }
    ...
    public String getUnlocalizedName(ItemStack itemStack) {
        return String.format(
            ...
            Names.Items.ALCHEMICAL_DUST,
            Names.Items.ALCHEMICAL_DUST_SUBTYPES[MathHelper.clamp_int(
                itemStack.getItemDamage(),
                0,
                Names.Items.ALCHEMICAL_DUST_SUBTYPES.length - 1
            )]
        );
    }
