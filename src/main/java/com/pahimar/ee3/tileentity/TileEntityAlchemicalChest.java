...
public class TileEntityAlchemicalChest extends TileEntityEE implements IInventory {
    ...
    public String getInventoryName() {
        return this.hasCustomName() ? this.getCustomName()
                                    : Names.Containers.ALCHEMICAL_CHEST;
    }
    ...
    public void openInventory() {
        ...
        worldObj.addBlockEvent(
            xCoord, yCoord, zCoord, ModBlocks.alchemicalChest, 1, numUsingPlayers
        );
    }
    ...
    /**
     * Allows the entity to update its state. Overridden in most subclasses, e.g. the mob
     * spawner uses this to count ticks and creates a new spawn inside its implementation.
     */
    @Override
