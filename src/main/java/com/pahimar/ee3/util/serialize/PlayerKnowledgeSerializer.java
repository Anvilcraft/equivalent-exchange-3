...
public class PlayerKnowledgeSerializer
    implements JsonSerializer<PlayerKnowledge>, JsonDeserializer<PlayerKnowledge> {
    @Override
        ...
        if (json.isJsonArray()) {
            ...
            while (jsonArrayIterator.hasNext()) {
                ...
                if (jsonElement.isJsonObject()) {
                    ...
                    try {
                        wrappedStack
                            = context.deserialize(jsonElement, WrappedStack.class);
                    } catch (JsonParseException e) {}

                    if (wrappedStack != null
                        && wrappedStack.getWrappedObject() instanceof ItemStack) {
    ...
    @Override
    public JsonElement
    serialize(PlayerKnowledge src, Type typeOfSrc, JsonSerializationContext context) {
