...
public class Files {
    ...
    private static final String PRE_CALCULATION_ENERGY_VALUES_FILENAME
        = "pre-calculation-energy-values.json";
    private static final String POST_CALCULATION_ENERGY_VALUES_FILENAME
        = "post-calculation-energy-values.json";

    public static final String TEMPLATE_PLAYER_KNOWLEDGE_FILENAME
        = "template-player-knowledge.json";
    ...
    public static void init(FMLPreInitializationEvent event) {
        ...
        EnergyValueRegistry.energyValuesDirectory
            = new File(globalDataDirectory, "energy-values");
        EnergyValueRegistry.energyValuesDirectory.mkdirs();
        EnergyValueRegistry.energyValuesFile = new File(
            EnergyValueRegistry.energyValuesDirectory, ENERGY_VALUES_JSON_FILENAME
        );
        ...
        File templatePlayerKnowledgeDirectory = new File(
            globalDataDirectory, "knowledge" + File.separator + "transmutation"
        );
        templatePlayerKnowledgeDirectory.mkdirs();
        PlayerKnowledgeRegistry.templatePlayerKnowledgeFile = new File(
            templatePlayerKnowledgeDirectory, TEMPLATE_PLAYER_KNOWLEDGE_FILENAME
        );
    ...
    /**
     * Updates the references to the instance specific EE3 data directories, creating them
