...
public class Names {
    ...
    public static final class Items {
        ...
        public static final String[] ALCHEMICAL_DUST_SUBTYPES
            = { "ash", "verdant", "azure", "minium" };
        ...
        public static final String[] ALCHEMICAL_FUEL_SUBTYPES
            = { ALCHEMICAL_COAL, MOBIUS_FUEL, AETERNALIS_FUEL };
        ...
        public static final String[] ALCHEMICAL_UPGRADE_SUBTYPES
            = { "verdant", "azure", "minium" };
        ...
        public static final String[] MATTER_SUBTYPES
            = { "Proto",    "Dark",      "Corporeal", "Kinetic", "Temporal",
                "Essentia", "Amorphous", "Void",      "Omni" };
        public static final String GEM = "gem";
        public static final String[] GEM_SUBTYPES
            = { "Black", "Blue", "Green", "Grey", "Purple", "Red", "Yellow" };
        public static final String KNOWLEDGE_SCROLL = "knowledgeScroll";
        public static final String POTION_LETHE = "potionLethe";
    }

    public static final class Fluids { public static final String MILK = "ee3.milk"; }
    ...
    public static final class NBT {
        ...
        public static final String ITEM_TRANSMUTATION_KNOWLEDGE
    ...
    public static final class Containers {
        ...
        public static final String ALCHEMICAL_BAG
            = "container.ee3:" + Items.ALCHEMICAL_BAG;
        public static final String ALCHEMICAL_CHEST
            = "container.ee3:" + Blocks.ALCHEMICAL_CHEST;
        ...
        public static final String RESEARCH_STATION
            = "container.ee3:" + Blocks.RESEARCH_STATION;
        public static final String GLASS_BELL = "container.ee3:" + Blocks.GLASS_BELL;
        public static final String AUGMENTATION_TABLE
            = "container.ee3:" + Blocks.AUGMENTATION_TABLE;
        public static final String ALCHENOMICON = "container.ee3:" + Items.ALCHENOMICON;
        public static final String TRANSMUTATION_TABLET
            = "container.ee3:" + Blocks.TRANSMUTATION_TABLET;
    }
    ...
    public static final class Commands {
        ...
        public static final String SET_ENERGY_VALUE_CURRENT_ITEM
            = "set-energy-value-current-item";
        ...
        public static final String PLAYER_LEARN_CURRENT_ITEM
            = "player-learn-current-item";
        ...
        public static final String PLAYER_FORGET_CURRENT_ITEM
            = "player-forget-current-item";
        public static final String SET_ITEM_LEARNABLE = "set-item-learnable";
        public static final String SET_CURRENT_ITEM_LEARNABLE
            = "set-current-item-learnable";
        public static final String SET_ITEM_NOT_LEARNABLE = "set-item-not-learnable";
        public static final String SET_CURRENT_ITEM_NOT_LEARNABLE
            = "set-current-item-not-learnable";
        public static final String SET_ITEM_RECOVERABLE = "set-item-recoverable";
        public static final String SET_CURRENT_ITEM_RECOVERABLE
            = "set-current-item-recoverable";
        public static final String SET_ITEM_NOT_RECOVERABLE = "set-item-not-recoverable";
        public static final String SET_CURRENT_ITEM_NOT_RECOVERABLE
            = "set-current-item-not-recoverable";
    ...
    public static final class AlchemyArrays {
        ...
        public static final String ACCELERANT_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "accelerant";
        public static final String COMBUSTION_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "combustion";
        public static final String CONSTRUCTION_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "construction";
        public static final String CONVEYOR_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "conveyor";
        public static final String DESTRUCTION_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "destruction";
        public static final String GELID_ALCHEMY_ARRAY = ALCHEMY_ARRAY_BASE + "gelid";
        public static final String PARTHENOGENESIS_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "parthenogenesis";
        public static final String TRANSFIGURATION_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "transfiguration";
        public static final String TRANSMUTATION_ALCHEMY_ARRAY
            = ALCHEMY_ARRAY_BASE + "transmutation";
    }
}
