...
public class MessageTileEntityAlchemyArray
    implements IMessage, IMessageHandler<MessageTileEntityAlchemyArray, IMessage> {
    ...
    public void fromBytes(ByteBuf buf) {
        ...
        if (compressedNBT != null) {
            try {
                this.tileEntityAlchemyArrayNBT = CompressedStreamTools.readCompressed(
