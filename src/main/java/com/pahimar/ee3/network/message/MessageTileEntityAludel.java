...
public class MessageTileEntityAludel
    implements IMessage, IMessageHandler<MessageTileEntityAludel, IMessage> {
    public int x, y, z;
    ...
    public MessageTileEntityAludel(
        TileEntityAludel tileEntityAludel, ItemStack outputItemStack
    ) {
    ...
    public IMessage onMessage(MessageTileEntityAludel message, MessageContext ctx) {
        ...
        if (tileEntity instanceof TileEntityAludel) {
            ...
            if (message.itemId != -1) {
                outputItemStack = new ItemStack(
                    Item.getItemById(message.itemId), message.stackSize, message.metaData
                );
