...
public class MessageGuiElementClicked
    implements IMessage, IMessageHandler<MessageGuiElementClicked, IMessage> {
    ...
    public IMessage onMessage(MessageGuiElementClicked message, MessageContext ctx) {
        ...
        if (entityPlayer != null
            && entityPlayer.openContainer instanceof IElementButtonHandler) {
