...
public class TileEntities {
    public static void init() {
        ...
        GameRegistry.registerTileEntityWithAlternatives(
            TileEntityAludel.class, Names.Blocks.ALUDEL, "tile." + Names.Blocks.ALUDEL
        );
        GameRegistry.registerTileEntityWithAlternatives(
        ...
        GameRegistry.registerTileEntity(
            TileEntityResearchStation.class, Names.Blocks.RESEARCH_STATION
        );
        GameRegistry.registerTileEntity(
            TileEntityAlchemyArray.class, Names.Blocks.ALCHEMY_ARRAY
        );
        GameRegistry.registerTileEntity(
            TileEntityDummyArray.class, Names.Blocks.DUMMY_ARRAY
        );
        GameRegistry.registerTileEntity(
            TileEntityTransmutationTablet.class, Names.Blocks.TRANSMUTATION_TABLET
        );
    }
}
