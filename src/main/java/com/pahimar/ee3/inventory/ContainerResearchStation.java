...
public class ContainerResearchStation extends ContainerEE {
    ...
    public ContainerResearchStation(
        ...
        for (int inventoryRowIndex = 0; inventoryRowIndex < PLAYER_INVENTORY_ROWS;
            ...
            for (int inventoryColumnIndex = 0;
                ...
                this.addSlotToContainer(new Slot(
                    ...
                    50 + inventoryColumnIndex * 18,
                    152 + inventoryRowIndex * 18
                ));
            }
        }
        ...
        for (int actionBarSlotIndex = 0; actionBarSlotIndex < PLAYER_INVENTORY_COLUMNS;
             ++actionBarSlotIndex) {
            this.addSlotToContainer(new Slot(
                inventoryPlayer, actionBarSlotIndex, 50 + actionBarSlotIndex * 18, 210
            ));
        }
    }
    ...
    public void addCraftingToCrafters(ICrafting iCrafting) {
        ...
        iCrafting.sendProgressBarUpdate(
            this, 0, this.tileEntityResearchStation.itemLearnTime
        );
