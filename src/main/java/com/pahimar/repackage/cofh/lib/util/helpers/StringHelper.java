...
public final class StringHelper {
    ...
    /* FORMAT HELPERS */
    public static int
    getSplitStringHeight(FontRenderer fontRenderer, String input, int width) {
    ...
    public static String shiftForDetails() {
        return LIGHT_GRAY + localize("info.cofh.hold") + " " + YELLOW + ITALIC
            + localize("info.cofh.shift") + " " + END + LIGHT_GRAY
