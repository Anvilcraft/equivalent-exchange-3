...
/**
 * Base class for a tab element. Has self-contained rendering methods and a link back to
 * the {@link GuiBase} it is a part of.
 *
 * @author King Lemming
 */
public abstract class TabBase extends ElementBase {
    ...
    public static final ResourceLocation DEFAULT_TEXTURE_LEFT
        = new ResourceLocation(GuiProps.PATH_ELEMENTS + "Tab_Left.png");
    public static final ResourceLocation DEFAULT_TEXTURE_RIGHT
        = new ResourceLocation(GuiProps.PATH_ELEMENTS + "Tab_Right.png");
    ...
    public void update() {
        ...
        if (!fullyOpen && open && currentWidth == maxWidth
            && currentHeight == maxHeight) {
            setFullyOpen();
        }
    }
    ...
    protected void drawBackground() {
        ...
        gui.drawTexturedModalRect(
            xPosition, posY + 4, 0, 256 - currentHeight + 4, 4, currentHeight - 4
        );
        gui.drawTexturedModalRect(
            xPosition + 4, posY, 256 - currentWidth + 4, 0, currentWidth - 4, 4
        );
    ...
    /**
     * Corrects for shadowing differences in tabs to ensure that they always look nice -
     * used in font rendering, typically.
     */
    ...
    public Rectangle4i getBounds() {
        if (isVisible()) {
            ...
            return new Rectangle4i(
                posX() + gui.getGuiLeft(), posY + gui.getGuiTop(), 0, 0
            );
        }
    }
}
