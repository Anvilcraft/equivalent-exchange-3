...
/**
 * Base class for a modular GUI element. Has self-contained rendering methods and a link
...
public abstract class ElementBase {
    ...
    public void
    drawCenteredString(FontRenderer fontRenderer, String text, int x, int y, int color) {
    ...
    public boolean intersectsWith(int mouseX, int mouseY) {
        return mouseX >= this.posX && mouseX <= this.posX + this.sizeX
