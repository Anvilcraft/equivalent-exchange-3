...
/**
 * Slot that will redirect inserts to another inventory slot (other than index), but not
 * be visible. <p/> Used primarily for containers that have a larger internal inventory
 * than external (e.g., DeepStorageUnit)
 */
