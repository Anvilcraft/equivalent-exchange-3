...
/**
 * Slot that will only accept ItemStacks when the IInventory returns true from
 * isItemValidForSlot. <p/> If an ISidedInventory, canInsertItem (from side 6 (UNKNOWN))
...
public class SlotAcceptInsertable extends SlotAcceptValid {
    ...
    public boolean isItemValid(ItemStack stack) {
        ...
        return valid && sidedInv != null ? sidedInv.canInsertItem(slotNumber, stack, 6)
                                         : valid;
    }
}
