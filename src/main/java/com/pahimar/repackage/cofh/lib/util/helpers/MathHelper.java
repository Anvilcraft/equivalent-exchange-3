...
/**
 * Contains various math-related helper functions. Often faster than conventional
 * implementations.
 *
 * @author King Lemming
 */
public final class MathHelper {
    ...
    /**
     * Unchecked implementation to round a number. Parameter should be known to be valid
     * in advance.
     */
    ...
    /**
     * Unchecked implementation to round a number up. Parameter should be known to be
     * valid in advance.
     */
    ...
    /**
     * Unchecked implementation to round a number down. Parameter should be known to be
     * valid in advance.
     */
    ...
    /**
     * Unchecked implementation to determine the smaller of two Floats. Parameters should
     * be known to be valid in advance.
     */
    ...
    /**
     * Unchecked implementation to determine the larger of two Floats. Parameters should
     * be known to be valid in advance.
     */
